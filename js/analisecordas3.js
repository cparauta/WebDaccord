...
function preload() {
    ...
    pitchcordas3 = loadTable("/Pitch/pitchcordas3.txt", "csv") // Pitch
...
function setup() {
  ...
  noStroke();
  fullscreen();
  notas1.push(parseInt(pitchcordas3.getString(0,0))+(12*5))
  notas1.push(parseInt(pitchcordas3.getString(0,1))+(12*5))
  notas1.push(parseInt(pitchcordas3.getString(0,2))+(12*5))
  notas2.push(parseInt(pitchcordas3.getString(1,0))+(12*5))
  notas2.push(parseInt(pitchcordas3.getString(1,1))+(12*5))
  notas2.push(parseInt(pitchcordas3.getString(1,2))+(12*5))
  notas3.push(parseInt(pitchcordas3.getString(2,0))+(12*5))
  notas3.push(parseInt(pitchcordas3.getString(2,1))+(12*5))
  notas3.push(parseInt(pitchcordas3.getString(2,2))+(12*5))
  notas4.push(parseInt(pitchcordas3.getString(3,0))+(12*5))
  notas4.push(parseInt(pitchcordas3.getString(3,1))+(12*5))
  notas4.push(parseInt(pitchcordas3.getString(3,2))+(12*5))
  notas5.push(parseInt(pitchcordas3.getString(4,0))+(12*5))
  notas5.push(parseInt(pitchcordas3.getString(4,1))+(12*5))
  notas5.push(parseInt(pitchcordas3.getString(4,2))+(12*5))
  notas6.push(parseInt(pitchcordas3.getString(5,0))+(12*5))
  notas6.push(parseInt(pitchcordas3.getString(5,1))+(12*5))
  notas6.push(parseInt(pitchcordas3.getString(5,2))+(12*5))
  notas7.push(parseInt(pitchcordas3.getString(6,0))+(12*5))
  notas7.push(parseInt(pitchcordas3.getString(6,1))+(12*5)) 
  notas7.push(parseInt(pitchcordas3.getString(6,2))+(12*5))
